                ...
                <header className="relative h-screen w-full overflow-hidden flex items-center justify-center">
                    ...
                    <div className="relative z-10 container mx-auto px-6 text-center text-white">
                        <div className="inline-block mb-6 px-4 py-1.5 border border-white/30 backdrop-blur-sm rounded-full bg-black/20 text-sm font-medium tracking-wider uppercase">
                            {getLocalizedCategoryName("Longform")}
                        </div>
                ...
                <article className="pt-16 pb-8 px-6">
                    <div className="max-w-[800px] mx-auto">
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-100 flex flex-row items-center">
                            <ShareButtons url={window.location.href} title={article.title} category={article.category} label={null} />
                        </div>
                        ...
                        <section className="mt-8 pt-8 border-t border-gray-100">
                            <div className="flex items-center gap-3 mb-10">
                                ...
                                />
                                <h3 className="text-xl font-bold text-gray-900 uppercase tracking-tight text-[#8b0000]">{getLocalizedCategoryName("Longform").toUpperCase()}</h3>
                            </div>
